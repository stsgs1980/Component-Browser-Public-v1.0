...
/**
 * TerminalFrame — wraps content in a macOS-style terminal window.
 * Uses design-token colors (bg-card, bg-muted) so it works in both light & dark themes.
 *
 * Source: Wiki-Codex-v2 /src/components/codex/terminal-frame.tsx
 * De-hardcoded: none — already fully generic, zero domain coupling.
 */
